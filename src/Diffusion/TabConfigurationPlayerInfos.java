...
public class TabConfigurationPlayerInfos extends JPanel {
    ...
    /** The elements. */
    private String[] elements = {"name", "Surname", "DisplayName","Img", "Flag", "Acro", "Country", "Line", "Rank", "BirthDate", "BirthPlace", "Height", "Weight", "Hand", "Age", "Prizetotal", "Cityresidence","Seeding"};
    ...
    private void setPositionElement(String element, int x, int y) {
        ...
        switch (element) {
            ...
            case "Surname":
                ...
                break;
            case "DisplayName":
            	setPosition(infosPlayerDetails.playerDisplayName, x, y, tabPolice.checkboxDisplayName);
            	break;
            case "Img":
                setPositionImg(x, y);
                break;
...
//        System.out.println("Refresh player spinner : " + infosPlayerDetails.nameLabel.getText() + " current player : " + this.joueur.getDisplay_name());
    ...
    private JComponent getComponentByName(String name, PlayerForDiffusion infosPlayerDetails) {
        switch (name) {
            ...
            case "DisplayName": return infosPlayerDetails.playerDisplayName;
