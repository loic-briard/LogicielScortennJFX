...
//        // Vérifier si le fichier est chargé depuis le JAR
//        URL resource = MainJFX.class.getResource("/" + resourcePath);
//        
//        if (resource != null) {
//            // Si on est dans un JAR, utiliser le chemin relatif
//            return MainJFX.class.getResource("/" + resourcePath).toString();
//        } else {
//            // Sinon, retourner le chemin absolu du fichier sur le disque (Eclipse)
